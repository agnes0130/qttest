...
#define AD_SPI_MISO_PIN                  GPIO_Pin_9
#define AD_SPI_MISO_GPIO_PORT            GPIOC 
#define AD_SPI_MISO_GPIO_CLK             RCC_APB2Periph_GPIOC
...
#define AD_CONVST_GPIO_CLK               RCC_APB2Periph_GPIOC

#define AD_RANGE_PIN                     GPIO_Pin_8
#define AD_RANGE_GPIO_PORT               GPIOC		
#define AD_RANGE_GPIO_CLK                RCC_APB2Periph_GPIOC
